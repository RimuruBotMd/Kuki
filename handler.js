		...
		try {
			...
			try {
				...
				if (user) {
                    ...
                    if (!isNumber(user.lastcraft)) user.lastcraft = 0
                    if (!isNumber(user.lastmeracik)) user.lastmeracik = 0
                    if (!isNumber(user.lastclaim)) user. lastclaim = 0
					...
					if (!isNumber(user.lastberburu)) user.lastberbru = 0
...
text: '```🚩 Akses Bot Ke Private Chat Di Tolak, Silahkan Upgrade Premium Hanya 5.000 Idr Agar Bisa Bebas Akses Bot Dengan Hubungi Owner Ketik .owner / .premium!\n\n• Join Ke Group Official Bot Untuk Free Akses & Informasi Kedepannya Tentang Bot : https://chat.whatsapp.com/EHvO9j6JMHb9roHNTvtbdy```',
contextInfo: {
externalAdReply: { showAdAttribution: true, 
title: '© Remii Beta - Sazumi Kemii',
thumbnailUrl: 'https://telegra.ph/file/cc131212ecaa31e9419f2.jpg',
mediaType: 1,
renderLargerThumbnail: true 
}}}, { quoted: m}) // By KrizynOfc
			...
			for (let name in global.plugins) {
				...
				if ((usedPrefix = (match[0] || '')[0])) {
					...
					if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
						this.reply(m.chat, `🐱 Your limit runs out, please buy through ${usedPrefix}buylimit, or contact the owner Sazumi Kemii +12024988527`, m)
						continue
					}
					...
					try {
						...
						if (e) {
							...
							for (let key of Object.values(APIKeys))
								text = text.replace(new RegExp(key, 'g'), 'UPS')
							if (e.name)
...
thumbnailUrl: pp,
sourceUrl: `https://instagram.com/sazumi.kemii`,
mediaType: 1,
renderLargerThumbnail: true 
}}}, { quoted: null})
                        }
...
global.dfail = (type, m, conn) => {
    ...
    let msg = {
        ...
        group: `${nmsr}\n\nPerintah ini hanya dapat digunakan di grup!\n\nhttps://chat.whatsapp.com/EHvO9j6JMHb9roHNTvtbdy`,
    ...
    let daftar = 'https://telegra.ph/file/11b88ab0a762af1b8cf59.jpg'
    let msgg = {
        unreg: `sɪʟᴀʜᴋᴀɴ ᴅᴀғᴛᴀʀ ᴋᴇ *ᴅᴀᴛᴀʙᴀsᴇ* ʙᴏᴛ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ ᴊɪᴋᴀ ɪɴɢɪɴ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ғɪᴛᴜʀ ᴋɪᴋᴜᴄʜᴀɴᴊ!

ᴍᴀɴᴜᴀʟ ᴅᴀꜰᴛᴀʀ ᴄᴏɴᴛᴏʜ:
#ᴅᴀғᴛᴀʀ ɴᴀᴍᴀᴍᴜ.ᴜᴍᴜʀᴍᴜ

ᴇᴍᴀɪʟ ᴅᴀꜰᴛᴀʀ ᴄᴏɴᴛᴏʜ:
#ʀᴇɢ ᴋɪᴋᴜᴄʜᴀɴᴊ@ɢᴍᴀɪʟ.ᴄᴏᴍ

ʀᴇɢɪꜱᴛᴇʀ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ᴇᴍᴀɪʟ ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴀᴘᴀᴛᴋᴀɴ 1ᴋ ʟɪᴍɪᴛ`
    }[type]
    if (msgg) return conn.reply(m.sender, msgg, m, {
contextInfo: {
externalAdReply: {
